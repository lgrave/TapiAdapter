...
//
//	$Log: XmlRpcUtil.cpp,v $
//	Revision 1.3.2.1  2010-07-22 10:16:38  lgrave
...
public:
  ...
  void log(int level, const char* msg) { 
	...
	if(theLog)
	{
		switch(level)
		{
			case 0: //theLog->Fatal(msg); break;
			case 1: //theLog->Error(msg); break;
			case 2: //theLog->Warning(msg); break;
			case 3: //theLog->Default(msg); break;
			case 4: //theLog->Details(msg); break;
			case 5: theLog->Debug(msg); break;
			;
		}
	}
// #ifdef USE_WINDOWS_DEBUG
